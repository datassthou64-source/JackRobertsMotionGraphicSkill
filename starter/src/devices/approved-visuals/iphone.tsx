...
export function Iphone({
  ...
  return (
    <div
      ...
      style={{
        position:"relative",display:"inline-block",width:"100%",lineHeight:0,
    ...
    >
      ...
      {screen && <div style={{position:"absolute",left:`${LEFT_PCT}%`,top:`${TOP_PCT}%`,width:`${WIDTH_PCT}%`,height:`${HEIGHT_PCT}%`,borderRadius:`${RADIUS_H}% / ${RADIUS_V}%`,overflow:"hidden"}}>{screen}</div>}
      {!hasVideo && src && (
        <div
